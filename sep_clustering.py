...
def sep_clustering(mat, cluster_method='hier', dist_type='cosine', linkage_type='average', group_type='maxclust'):
    dim_groups = cluster_dimensions(mat, cluster_method, dist_type, linkage_type, group_type)
    inst_groups = cluster_instances(mat, cluster_method, dim_groups, dist_type, linkage_type, group_type)

    return dim_groups, inst_groups


def cluster_dimensions(mat, cluster_method, dist_type='cosine', linkage_type='average', group_type='maxclust'):
...
def cluster_instances(mat, cluster_method, dim_groups, dist_type='cosine', linkage_type='average', group_type='maxclust'):
    inst_groups = {}
